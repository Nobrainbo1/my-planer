...
[planner](skills/planner/SKILL.md); [grill-with-docs](skills/grill-with-docs/SKILL.md)
...
- After editing, check local Markdown links and skill frontmatter. Use the planner's [evaluation cases](skills/planner/references/EVALUATION.md) for substantial behavior changes. Report what was actually checked.
...
- Do not assume this nested `AGENTS.md` or slash commands load automatically in every coding tool. Explicitly point the agent to the desired `SKILL.md` when needed.
