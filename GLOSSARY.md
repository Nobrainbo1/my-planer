...
| Term | Plain English |
|------|--------------|
| **Human-in-the-loop** | A human reviews and approves at key checkpoints. The agent proposes; the human decides. This template uses three checkpoints: after Phase 2 (Plan Approval), after Phase 4 (Implementation Review), and in Phase 6 (Deployment Approval). |
